#!/usr/bin/env python3
"""Generate a concrete INI and scenario XML for lagged_fairness."""
...
def main():
    ...
    experimentTools.experiment_cli(
        default_template=base / "config_lagged_fairness.ini",
        default_output=base / "generated_lagged_fairness.ini",
    )
