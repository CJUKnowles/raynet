...
if __name__ == '__main__':
    ...
    config = (
            ...
            .env_runners(num_env_runners=num_workers, num_cpus_per_env_runner=1, num_envs_per_env_runner=1, explore=False) #, rollout_fragment_length=1000
            .environment(env_name, env_config=env_config, disable_env_checking=True) # "OmnetGymApiEnv
            .training(
                num_steps_sampled_before_learning_starts=600000
                )
