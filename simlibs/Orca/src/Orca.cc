...
std::optional<ObsType> Orca::computeObservation(){
    ...
    ObsType observation({
        {"delay_ms", averageDelayMs},
        {"avg_thr", this->orcaThroughput},
        {"throughput", this->orcaThroughput},
        {"count", this->rttReportCount},
        {"cnt", this->rttReportCount},
        {"samples", this->rttReportCount},
        {"interval_s", lastIntervalDuration},
        {"delta_t", lastIntervalDuration},
        {"target", 50.0},
        {"cwnd", cwndPackets},
        {"pacing_rate", pacingRate},
        {"loss_rate", this->lossRate},
        {"lost_rate", this->lossRate},
        {"loss_bytes", this->lossRate},
        {"lost_bytes", this->lossRate},
        {"srtt_us", srttUs},
        {"srtt_ms", srttUs},
        {"snd_ssthresh", ssthreshPackets},
        {"packets_out", packetsOut},
        {"retrans_out", retransOut},
        {"max_packets_out", packetsOut},
        {"mss", state->snd_mss},
        {"mss_cache", state->snd_mss},
        {"min_rtt_ms", minRttMs},
        {"avg_urtt", averageDelayUs},
        {"delay_us", averageDelayUs},
        {"min_rtt", minRttUs},
        {"min_rtt_us", minRttUs}
    });
